...
export function Model(props) {
  const { nodes, materials } = useGLTF('https://whitepirate-bucket.s3.amazonaws.com/pirate_draco.gltf')
...
useGLTF.preload('https://whitepirate-bucket.s3.amazonaws.com/pirate_draco.gltf')
